...
public class UserManagementFrame extends JFrame {
    ...
    public UserManagementFrame(Frame owner, UserService userService) {
        ...
        this.tableModel = new DefaultTableModel(new String[]{"User ID", "Username", "Role", "Active"}, 0) {
            @Override
    ...
    private void initialize(Frame owner) {
        ...
        setContentPane(root);
        root.add(Theme.banner("User Management", "Create and manage system accounts", 48), BorderLayout.NORTH);
    ...
    private static class UserFormDialog extends JDialog {
        ...
        private void initialize(boolean editing) {
            ...
            root.setBackground(Theme.BG);
            setContentPane(root);
            root.add(Theme.banner(editing ? "Edit User" : "Add User", null, 40), BorderLayout.NORTH);
            ...
            UiUtil.addFormRow(form, gbc, 1, editing ? "New Password (optional):" : "Password:", passwordField);
            UiUtil.addFormRow(form, gbc, 2, "Role:", roleComboBox);
            UiUtil.addFormRow(form, gbc, 3, "", activeCheckBox);
